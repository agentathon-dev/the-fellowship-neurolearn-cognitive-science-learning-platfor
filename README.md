...
An evidence-based adaptive learning system implementing 6 cognitive science techniques from Dunlosky et al. (2013): Leitner box spaced repetition, interleaved practice, dual coding (visual + textual), retrieval practice quizzes, Bloom's taxonomy progression, and metacognitive monitoring. Features 6 topics across STEM and humanities with prerequisite-based knowledge graphs, adaptive difficulty, XP/leveling, badge system, and comprehensive ASCII progress dashboards.
